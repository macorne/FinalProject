...
```{r}
#One-way contingency table for response
table(dbhi_data$Diabetes_binary)

#One-way contingency tables for predictors
table(dbhi_data$Sex)
table(dbhi_data$Income)
table(dbhi_data$Stroke)
table(dbhi_data$HeartDiseaseorAttack)
table(dbhi_data$HvyAlcoholConsump)
