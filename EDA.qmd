...
We will summarize our numeric variables over the entire set of respondents, then filter for diabetes status:
...
We will also look for relationships between diabetes status, sex, and alcohol consumption across age brackets:
...
ggplot(data, 
  ...
  facet_wrap(~ HeartDiseaseorAttack)
...
ggplot(data |> filter(PhysHlth > 1 & PhysHlth < 30),
  ...
  geom_histogram(alpha=0.5,
    ...
    position = "identity",
    binwidth=1) + 
  scale_fill_manual(values=c("#E69F00", "#56B4E9")) + xlab("PhysHlth") + ylab("Density") + ggtitle(str_wrap("Number of Respondents per Number of Days of Physical Illness or Injury, by Presence or Absence of Diabetes",30)) + theme(plot.title = element_text(hjust = 0.5))
...
ggplot(data |> filter(MentHlth > 1 & MentHlth < 30),
  ...
  geom_histogram(alpha=0.5,
    ...
    position = "identity",
    binwidth=1) + 
  scale_fill_manual(values=c("#E69F00", "#56B4E9")) + xlab("MentHlth") + ylab("Density") + ggtitle(str_wrap("Number of Respondents per Number of Poor Mental Health Days, by Presence or Absence of Diabetes",30)) + theme(plot.title = element_text(hjust = 0.5))
...
ggplot(data,
  ...
  geom_histogram(alpha=0.5,
    ...
    position = "identity",
    binwidth=1) + 
  scale_fill_manual(values=c("#E69F00", "#56B4E9")) + xlab("BMI") + ylab("Density") + ggtitle(str_wrap("Number of Respondents per BMI, by Presence or Absence of Diabetes",30)) + theme(plot.title = element_text(hjust = 0.5))

ggplot(data) +
geom_boxplot(aes(x = Sex, y = BMI, fill = Diabetes_binary)) + scale_fill_manual(values=c("#E69F00", "#56B4E9")) +
  facet_wrap(~ Age,nrow=7,ncol=2)
```
