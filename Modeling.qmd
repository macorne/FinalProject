...
Write an intro! We will include 5 predictors in this model: age, sex, stroke, heart disease or attack, and heavy alcohol consumption.
...
dbhi_recipe <- recipe(Diabetes_binary ~ ., data = dbhi_train) |>
  update_role(Income,Smoker,BMI,HighBP,HighChol,CholCheck,PhysActivity,Fruits,Veggies,AnyHealthcare,NoDocbcCost,GenHlth,MentHlth,PhysHlth,DiffWalk,Education,new_role = "bystander") |>
...
```{r}
#mtry=11 for the API.R file (was 9 for Income instead of Age)
